"""
Base scheduler interface for all scheduling algorithms.

This module defines the abstract base class that all schedulers must implement.
"""
...
class BaseScheduler(ABC):
    ...
    the schedule() and compute_total_cost() methods.
    ...
    def __init__(self, dram_capacity_mb: float, cxl_capacity_mb: float):
        """
        Initialize scheduler with memory tier capacities.
    ...
    def schedule(self, tasks: List[Task]) -> Dict[int, str]:
        """
        Schedule tasks to memory tiers.
